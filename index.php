...
<meta charset="UTF-8">
  ...
  <br>
    <div class="login-box">
      <div style="color:#2ECCFA" class="login-logo">
        <img style="margin-top:-15px" src="assets/img/ms-icon-70x70.png" alt="Logo" > <b>THN Py S.A </b><!---es efav, pone uno de 70x70, chico es la onda-->
      </div><!-- /.login-logo -->
      <?php  
      ...
      elseif($_GET['alert']==4){
        echo "<div class='alert alert-danger alert-dismissable'>
        <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
        <h4> <i class='icon fa fa-times-circle'></i>Demasiados intentos</h4>
        El usuario se encuentra bloqueado, por favor, contacte con el Administrador al correo: rojasvictor745@gmail.com
        </div>";
    }
