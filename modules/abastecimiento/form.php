<?php 
    if($_GET['form']=='add'){ ?>
      ...
      <h1>
        <i class="fa fa-edit icon-title">Agregar Abastecimiento</i>
      </h1>
      <ol class="breadcrumb">
        <li><a href="?module=start"><i class="fa fa-home"></i>Inicio</a></li>
        <li><a href="?module=abastecimiento"> Abastecimiento</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    <form role="form" class="form-horizontal" action="modules/abastecimiento/proses.php?act=insert" method="POST">
                        <div class="box-body">
                            <?php
                            //Método para generar código
                                $query_id = mysqli_query($mysqli, "SELECT MAX(cod_abastecimiento) as id FROM abastecimiento")
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                <label class="col-sm-2 control-label">Materias Primas</label>
                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">
                                    <span class="glyphicon glyphicon-plus">Agregar Materias Primas</span>
                                    </button>
                                </div>
                            </div>
        ...
        function load(page){
            ...
            $.ajax({
                ...
                beforeSend: function(objeto){
                    $('#loader').html('<img src="./images/user/ajax-loader.gif"> Cargando...');
                },
         ...
         <div class="modal-content">
            <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModallabel">Buscar Materias Primas</h4>
            </div>
