...
<h1>
    <i class="fa fa-folder icon-title"></i>Datos de Depositos
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            elseif($_GET['alert']==5){
                ...
                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
                <h4>  <i class='icon fa fa-check-circle'></i> Error!</h4>
                El dato Ingresado ya se encuentra Registrado! Favor ingrese otro dato!
                </div>";
            }
            ?>
            ...
            <div class="box box-primary">
                ...
                <section class="content-header">
                    <a class="btn btn-warning btn-social pull-right" href="modules/deposito/print.php" target="_blank">
                        <i class="fa fa-print"></i>Imprimir Reporte de Depositos
                    </a>
                </section>
                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                                ...
                                onclick="return confirm('¿Estás seguro/a de eliminar <?php echo $data['descripcion']; ?>?')">
