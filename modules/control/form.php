<?php 
    if($_GET['form']=='add'){?>
        <section class="content-header">
            <h1>
                <i class="fa fa-edit icon-title"></i>Agregar Control de Calidad
            </h1>
            <ol class="breadcrumb">
                <li><a href="?module=start"><i class="fa fa-home"></i> Inicio</a></li>
                <li><a href="?module=control">Control de Calidad</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <form role="form" class="form-horizontal" action="modules/control/proses.php?act=insert" method="POST">
                            <div class="box-body">
                                <?php 
                                    $query_id = mysqli_query($mysqli, "SELECT MAX(cod_calidad) AS id FROM control_calidad")
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Código de Control</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Descripción de Control de Calidad:</label>
                                       <div class="col-sm-3">
                                            <input type="text" class="form-control" name="descri_calidad" autocomplete="off" placeholder="Ingresa una Descripción" required>
                                        </div>
                                    </div>
                                </div>  
