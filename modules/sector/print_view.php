...
<html lang="es">
    <head>
        <meta charset="UTF-8">
        <title>Reporte de Sectores de Trabajo</title>
    </head>
    <body>
            ...
            <table width="100%" border="0.3" cellpaddign="0" cellspacing="0" align="center">
                <thead style="background:#3A7EAE">
                    <tr class="tabla-title" style="background: #3A7EAE">
                        <th height="30" align="center" valign="middle"><small>N° de Sector</small></th>
                ...
                <tbody>
                    <?php
                     ...
                     while($data = mysqli_fetch_assoc($query)){
                        ...
                        echo "<tr>
                        <td width='100' align='center'>$cod_sector</td>
                        <td width='200' align='left'>$descrip_sector</td>
