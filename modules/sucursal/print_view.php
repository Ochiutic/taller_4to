            ...
            <table width="100%" border="0.3" cellpaddign="0" cellspacing="0" align="center">
                <thead style="background:#3A7EAE">
                    <tr class="tabla-title" style="background: #3A7EAE">
                        <th height="30" align="center" valign="middle"><small>N° de sucursal</small></th>
                        <th height="30" align="center" valign="middle"><small>Sucursales</small></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                     ...
                     while($data = mysqli_fetch_assoc($query)){
                        ...
                        echo "<tr>
                        <td width='100' align='center'>$cod_sucursal</td>
