...
<ol class="breadcrumb">
    ...
    <li class="active"><a href="?module=sector">Clientes</a></li>
</ol><br><hr>
<h1>
...
<h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form_pedidos&form=add" title="Agregar" data-toggle="tooltip">
        <i class="fa fa-plus"></i>Pedidos de Clientes.
    </a>
</h1>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-body">
                <section class="content-header">
                    <a class="btn btn-warning btn-social pull-right" href="modules/razon_social/print.php" target="_blank">
                    <i class="fa fa-print"></i>Imprimir Clientes
                    </a>
                </section>
                    ...
                    <table id="dataTables1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            while($data = mysqli_fetch_assoc($query)){
                               ...
                               echo "<tr>
                               <td class='center'>$cod_razon</td>
                               <td class='center'>$descrip_razon</td>
                               ...
                               class='btn btn-primary btn-sm' href='?module=form_razon_social&form=edit&id=$data[cod_razon]'>
                                ...
                                href="modules/razon_social/proses.php?act=delete&cod_razon=<?php echo $data['cod_razon']; ?>"
                                onclick="return confirm('¿Estás seguro/a de eliminar <?php echo $data['descrip_razon']; ?>  <?php echo $data['descrip_razon']; ?> <?php echo $data['ci_ruc']; ?>?')">
