<?php 
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <form role="form" class="form-horizontal" action="modules/productos/proses.php?act=insert" method="POST">
                            <div class="box-body">
                                <?php 
                                    $query_id = mysqli_query($mysqli, "SELECT MAX(cod_producto) AS id FROM productos")
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="descrip_producto" autocomplete="off" placeholder="Ingresa una Descripción" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" name="part_number" autocomplete="off" placeholder="Ingresa una Orden" 
    ...
    elseif($_GET['form']=='edit'){
        if(isset($_GET['id'])){
            $query = mysqli_query($mysqli, "SELECT * FROM productos WHERE cod_producto= '$_GET[id]'")
            or die('error'.mysqli_error($mysqli));
