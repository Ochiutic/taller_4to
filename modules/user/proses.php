<!--- 10.2 PROCESAR FORMULARIO  USUARIO--->
...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
	...
	if ($_GET['act']=='insert') {
		if (isset($_POST['Guardar'])) {
			...
			$permisos_accesos = mysqli_real_escape_string($mysqli, trim($_POST['permisos_accesos']));

            $query = mysqli_query($mysqli, "INSERT INTO usuarios(username,password,name_user,permisos_accesos)
                                            VALUES('$username','$password','$name_user','$permisos_accesos')")
			...
			if (isset($_POST['id_user'])) {
				...
				if (empty($_FILES['foto']['name'])) {
                    ...
                    $query = mysqli_query($mysqli, "UPDATE usuarios SET username 	= '$username',
                    													...
                    													email       = '$email',
                    													telefono     = '$telefono',
                    													permisos_accesos   = '$permisos_accesos'
