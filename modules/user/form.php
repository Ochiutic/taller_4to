          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=insert" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="permisos_accesos" required>
                    <option value=""></option>
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/user/proses.php?act=update" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="form-control" name="permisos_accesos" required>
                    <option value="<?php echo utf8_encode($data['permisos_accesos']); ?>"><?php echo utf8_encode($data['permisos_accesos']); ?></option>
                    <option value="Super Admin">Super Admin</option>
                    <option value="Super">Supervisor</option>
