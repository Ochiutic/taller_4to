        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            <thead>
              ...
              <section class="content-header">
                    <a class="btn btn-warning btn-social pull-right" href="modules/user/print.php" target="_blank">
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      if ($data['foto']=="") { ?>
                        <td class='center'><img class='img-user' src='images/user/user-default.png' width='50'></td>
                      <?php
                      } else { ?>
                        <td class='center'><img class='img-user' src='images/user/<?php echo $data['foto']; ?>' width='50'></td>
                      <?php
                    }

              echo utf8_encode("  <td>$data[username]</td>
                      <td>$data[name_user]</td>
                      <td>$data[permisos_accesos]</td>
